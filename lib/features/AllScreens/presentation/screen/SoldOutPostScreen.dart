    ...
    return Scaffold(
      ...
      body: isLoading
        ...
        child: soldOutPosts.isEmpty
            ?  ListView(
          // Required for RefreshIndicator to work even when empty
          children: [
            SizedBox(height: 200),
            Center(child: Text('No sold out posts found.')),
          ],
        )
            : ListView.builder(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          if (post.weight != null && post.unit != null && post.weight!.isNotEmpty && post.unit!.isNotEmpty)
                            Text(
      ...
      /*    body: isLoading
          ? const Center(child: CircularProgressIndicator())
          : soldOutPosts.isEmpty
          ? const Center(child: Text('No sold out posts found.'))
          : ListView.builder(
        itemCount: soldOutPosts.length,
          itemBuilder: (context, index) {
            final post = soldOutPosts[index];
