...
import 'package:smart_gawali/features/AllScreens/presentation/screen/ForgotPasswordScreen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    super.initState();
    _checkLoginStatus();
    _storeDeviceToken(); // Store device token at startup
  }
  ...
  Future<void> _storeDeviceToken() async {
    try {
      ...
      if (token != null && token.isNotEmpty) {
        ...
        print("Device token stored at startup: $token");
      }
    } catch (e) {
  ...
  Future<void> loginUser() async {
    ...
    try {
      ...
      print("Device token for login: $deviceToken");
